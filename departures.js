...
//
//  Grupowanie słupków definiuje się w obiekcie `stopGroups`
//  poniżej. Każda grupa to jeden "przystanek" w liście
//  rozwijanej — może łączyć kilka słupków tej samej nazwy
//  (np. rondo z 4 słupkami) albo tylko wybrane słupki
//  (np. Błonie 01+02 jako "Błonie (pętla)", a 03+04 jako
//  "Błonie (centrum)").
//
//  Słupki NIE wymienione w żadnej grupie trafiają do
//  domyślnej grupy "Nazwa (słupek XX)" — zachowanie jak
//  dotychczas, więc nie trzeba konfigurować wszystkiego.
// =========================================================

// =========================================================
//  KONFIGURACJA GRUP PRZYSTANKÓW
//
//  Format:
//  "Wyświetlana nazwa grupy": [
//    ["Nazwa w danych",   "numer słupka"],
//    ["Nazwa w danych",   "numer słupka"],
//    ...
//  ]
//
//  Przykłady:
//  - Rondo z 4 słupkami jako 1 przystanek:
//    "Rondo Solidarności": [
//      ["Rondo Solidarności","01"],
//      ["Rondo Solidarności","02"],
//      ["Rondo Solidarności","03"],
//      ["Rondo Solidarności","04"],
//    ]
//
//  - Błonie z 4 słupkami jako 2 osobne przystanki:
//    "Błonie (przystanek wschodni)": [
//      ["Błonie","01"], ["Błonie","02"]
//    ],
//    "Błonie (przystanek zachodni)": [
//      ["Błonie","03"], ["Błonie","04"]
//    ],
// =========================================================
